...
Ext.define('CityApp.view.statistics.StatisticsController', {
    ...
    stsMap: null,
    /*
    We can now use the initialization function of the StatisticsController
     to trigger the store and load the data from the server. This is 
     achieved by executing the load function of the Districts store.
    */
    districts: null,
    barChart: null,
    //this is responsible for pie chart
    pieChart: null,
    // for enschede wfs
    defaultStyle: null,
    choroLayer: null,
    //this is for interaction on the map
    ...
    initializeView: function(){
        ...
        this.stsMap = CityApp.app.homeCtrl.createMap('brtachtergrondkaart', 'sts_map_panel');
        ...
        var districtsWMS = new ol.layer.Image({
            source: new ol.source.ImageWMS({
                ...
                params: {
                    'MAP': 'd:/iishome/student/s2326965/CityApp/app/api/adminboundaries.map',
                    'LAYERS': 'districts',
                    'SERVER': 'MapServer',
                    'TILED': true
                }
        ...
        //
        // adding layer for the boundary on enschede
        var boundaryWMS = new ol.layer.Image({
            source: new ol.source.ImageWMS({
                url: 'https://gisedu.itc.utwente.nl/cgi-bin/mapserv.exe?',
                params: {
                    'MAP': 'd:/iishome/student/s2326965/CityApp/app/api/adminboundaries.map',
       ...
       // this.stsMap.addControl(layer_switcher);
		...
		var RasterLayer = new ol.layer.Tile({
            source: new ol.source.TileWMS({
              url: "https://gisedu.itc.utwente.nl/cgi-bin/mapserv.exe?map=d:/iishome/student/s2326965/webmapping/rastermap.map&",
             params: {"LAYERS": "naturalearth", "TILED": true}
            })
        });
        this.stsMap.addLayer(RasterLayer);
        //this.stsMap.addLayer(districtsWMS);
        // add layer for vector enschede border
    ...
    renderVectorFeatures: function(){
        ...
        var featuresUrl = 'https://gisedu.itc.utwente.nl/cgi-bin/mapserv.exe?map='+
         'd:/iishome/student/s2326965/CityApp/app/api/adminboundaries.map'+
         '&service=WFS&version=1.1.0&request=GetFeature&typename=cbs:districts'+
         '&outputFormat=geojson&srsname=EPSG:28992&cityname=Haarlem';
    ...
    drawPieChart: function(districts, chartPanel){
        ...
        //pie chart interaction with diagram
        pc.obj.append('text')
            .attr('id','pie_title')
            .attr('x',0)
            .attr('y',147)
    ...
    /*- Draws a bar chart after one the data of the districts has been received -*/
    drawBarChart: function(districts, chartPanel){
        ...
        bc.obj.selectAll(".bar")
          ...
          .enter().append("rect")
            ...
            .style("fill", "#CACCCE")
            .style("fill-opacity", 0.4) 
            //coresponding events on mouse movement
